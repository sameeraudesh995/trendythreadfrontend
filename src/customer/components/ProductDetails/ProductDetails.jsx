...
import { Button, Rating, Container, Grid } from "@mui/material";
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6  lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              ...
              <h1 className="text-lg lg:text-xl text-gray-900 opacity-60 pt-1">
                Casual Regular Sleeves Solid Women White Top
              </h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex item-center space-x-3 ">
                    ...
                    <p className="m1-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">1785 Reviews</p>
                </div>
              ...
              <form className="mt-10">
                ...
                <Button  variant="text " sx={{px:"2rem", py:"1rem", bgcolor:"#9155fd", color:"white", fontWeight:"bold"}}>
                  Add to Cart
                </Button>
              </form>
            </div>
